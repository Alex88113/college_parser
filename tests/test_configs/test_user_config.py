...
class TestValidConfig:
    ...
    def test_username(self, get_env_data) -> None:
        assert get_env_data.get("username") == config_user.JOURNAL_NAME
    ...
    def test_password(self, get_env_data) -> None:
        assert get_env_data.get("password") == config_user.JOURNAL_PASSWORD
    ...
    def test_app_key(self, get_env_data) -> None:
        assert get_env_data.get("application_key") == config_user.APP_KEY
